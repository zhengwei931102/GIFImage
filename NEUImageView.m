...
@interface NEUImageView ()

@property (nonatomic, strong) NEUGIFImage *animatedImage;
...
- (void)setImage:(UIImage *)image
{
    ...
    if ([image isKindOfClass:[NEUGIFImage class]] && image.images) {
        if([image.images[0] isKindOfClass:UIImage.class])
            [super setImage:image.images[0]];
        else
            [super setImage:nil];
        self.currentFrame = nil;
        self.animatedImage = (NEUGIFImage *)image;
...
- (void)setAnimatedImage:(NEUGIFImage *)animatedImage
{
